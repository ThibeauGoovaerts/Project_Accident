...
namespace WebApplication4.Areas.Identity.Pages.Account {
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "Les mots de passent ne correspondent pas.")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    Person p = new Person { user = user, LastName = Input.Lastame.ToUpper(), FirstName = Input.Firstname, Role = 0 };
